Shader "Custom/cloud item potion shader"
{
    Properties
    {
   ...
   [HDR]_specColor ("Specular Color", Color) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
			...
			float4 albedoMap = tex2D(_MainTex, IN.uv_MainTex) * _specColor;
			float4 bubbleMap = tex2D(_BubbleTex, IN.uv_BubbleTex - float2(0, _Time.x * 3));
			

			o.Albedo = albedoMap.rgb + bubbleMap.r;
